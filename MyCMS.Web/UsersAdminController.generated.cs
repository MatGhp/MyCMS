...
namespace MyCMS.Web.Controllers
{
    ...
    public partial class T4MVC_UsersAdminController : MyCMS.Web.Controllers.UsersAdminController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MyCMS.ViewModels.Identity.RegisterViewModel userViewModel, string[] selectedRoles);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(MyCMS.ViewModels.Identity.RegisterViewModel userViewModel, string[] selectedRoles)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MyCMS.ViewModels.Identity.EditUserViewModel editUser, string[] selectedRole);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(MyCMS.ViewModels.Identity.EditUserViewModel editUser, string[] selectedRole)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
