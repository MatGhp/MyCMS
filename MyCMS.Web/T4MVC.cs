...
{
    public static MyCMS.Web.Controllers.AccountController Account = new MyCMS.Web.Controllers.T4MVC_AccountController();
    public static MyCMS.Web.Controllers.HomeController Home = new MyCMS.Web.Controllers.T4MVC_HomeController();
    public static AspNetIdentityDependencyInjectionSample.Controllers.ManageController Manage = new AspNetIdentityDependencyInjectionSample.Controllers.T4MVC_ManageController();
    public static MyCMS.Web.Controllers.RolesAdminController RolesAdmin = new MyCMS.Web.Controllers.T4MVC_RolesAdminController();
    public static MyCMS.Web.Controllers.UsersAdminController UsersAdmin = new MyCMS.Web.Controllers.T4MVC_UsersAdminController();
